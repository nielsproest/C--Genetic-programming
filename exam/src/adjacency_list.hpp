...
public: // PropertyGraph
	...
	//TODO: Cant have duplicate functions
	//So no property graph
	/*const VertexProp& operator[](const VertexDescriptor e) {
		return vList.at(e).prop;
	}
	const EdgeProp& operator[](const EdgeDescriptor e) {
